...
from app.generators.mock_data import build_petit_effectif_row_b, generate_dmi_med_rows
...
def get_dmi_med(
    ...
    **Colonnes communes** :
    ...
    if (
        ...
        return JSONResponse(content=build_petit_effectif_row_b("datasource", "med"))
